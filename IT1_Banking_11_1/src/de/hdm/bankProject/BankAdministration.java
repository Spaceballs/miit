...
public class BankAdministration {
    ...
    public Account cloneAccount(Account a) {
        ...
        try {
            newAccount = (Account) a.clone();
            newAccount = this.aMapper.insert(newAccount);
            bank.setAccounts(this.getAllAccounts());
        } catch (CloneNotSupportedException e) {
            System.out.println("Account not cloneable!");
        }
        return newAccount;
    }

    public Account createCurrencyAccountFor(Customer c, int currency) {
        Account a = new Account(c, currency);
        a = this.aMapper.insert(a);
        bank.setAccounts(getAllAccounts());
        return a;
    }
     ...
     * @param a
     * @param amount
     * @return der neue Betrag als double
     */
