...
public class BankInterface implements ActionListener, TreeSelectionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().equals("changeCustomer")) {
            if (selectedCustomer != null) {
                ...
                JOptionPane.showMessageDialog(frame, "Kein Kunde ausgew�hlt!");
            }
            return;
        }
        ...
        if (e.getActionCommand().equals("depositAmount")) {
            if (selectedAccount != null) {
                ...
                JOptionPane.showMessageDialog(frame, "Kein Konto ausgew�hlt!");
            }
            return;
        }
        ...
        if (e.getActionCommand().equals("interest")) {
            if (selectedAccount != null) {
                ...
                JOptionPane.showMessageDialog(frame, "Der Jahreszins betr�gt " + 
                                                      new DecimalFormat("##0.00#").format(interest)
                                                      + " Euro");
            } else {
                JOptionPane.showMessageDialog(frame, "Kein Konto ausgew�hlt!");
            }
    ...
    protected void generateMenus(JMenuBar menubar) {
        ...
        tmpMenuItem = new JMenuItem("�ndern");
        ...
        tmpMenuItem = new JMenuItem("L�schen");
