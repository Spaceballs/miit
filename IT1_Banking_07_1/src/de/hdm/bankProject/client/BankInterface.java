...
public class BankInterface implements ActionListener, TreeSelectionListener {
    ...
    protected void generateMenus(JMenuBar menubar) {
        ...
        tmpMenuItem = new JMenuItem("Anzahl möglicher Buchungen");
            ...
            public void actionPerformed(ActionEvent e) {
                if (selectedAccount != null) {
                    JOptionPane.showMessageDialog(frame,
                           "Anzahl möglicher Buchungen des Kontos "
                           + selectedAccount.getId()
                           + ": "
                           + selectedAccount.getTransactions().length);
                } else {
                    JOptionPane.showMessageDialog(frame, "Kein Konto ausgewählt!");
                }
            }
        ...
        tmpMenuItem = new JMenuItem("Wert des Transaktionen-Pointers");
        practiceMenu.add(tmpMenuItem);
        tmpMenuItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (selectedAccount != null) {
                    JOptionPane.showMessageDialog(frame,
                            "Wert des Transaktionen-Pointers des Kontos "
                            + selectedAccount.getId()
                            + ": "
                            + selectedAccount.getTransactionPointer()
                            );
                } else {
                    JOptionPane.showMessageDialog(frame, "Kein Konto ausgewählt!");
                }
